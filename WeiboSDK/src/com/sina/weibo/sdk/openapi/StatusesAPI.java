...
public class StatusesAPI extends AbsOpenAPI {
    ...
    private static final int WRITE_API_DESTROY         = 6;
     ...
     * @param listener
     */
    public void test(WeiboParameters params,RequestListener listener){
        requestAsync(sAPIList.get(READ_API_FRIENDS_TIMELINE), params, HTTPMETHOD_GET, listener);
    }
    /**
     * 发布微博
     ...
     * @param listener
     */
    public void send(WeiboParameters parameters,RequestListener listener){
        requestAsync(sAPIList.get(WRITE_API_UPDATE), parameters, HTTPMETHOD_POST, listener);
    }
     ...
     * @param listener
     */
    public void sendWithPic(WeiboParameters parameters,RequestListener listener){
        requestAsync(sAPIList.get(WRITE_API_UPLOAD), parameters, HTTPMETHOD_POST, listener);
    }
     ...
     * @param listener
     */
    public void report(WeiboParameters parameters,RequestListener listener){
        requestAsync(sAPIList.get(WRITE_API_REPOST), parameters, HTTPMETHOD_POST, listener);
    }
     ...
     * @param listener
     */
    public void destroy(WeiboParameters parameters,RequestListener listener){
        requestAsync(sAPIList.get(WRITE_API_DESTROY), parameters, HTTPMETHOD_POST, listener);
    }
