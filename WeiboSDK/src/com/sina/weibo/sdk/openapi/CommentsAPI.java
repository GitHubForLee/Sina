...
public class CommentsAPI extends AbsOpenAPI {
    ...
    public void showComments(WeiboParameters parameters,RequestListener listener){
        requestAsync(sAPIList.get(READ_API_SHOW), parameters, HTTPMETHOD_GET, listener);
    }
    /**
     * 获取当前登录用户所发出的评论列表。
     * 
     ...
     * @param listener
     */
    public void comment(WeiboParameters parameters,RequestListener listener){
        requestAsync(sAPIList.get(WRITE_API_CREATE), parameters, HTTPMETHOD_POST, listener);
    }
