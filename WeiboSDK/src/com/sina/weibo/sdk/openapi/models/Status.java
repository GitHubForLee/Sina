...
//        status.retweetStatus    = RetweetStatus.parse(jsonObject.optJSONObject("retweeted_status"));
        ...
        if (picUrlsArray != null && picUrlsArray.length() > 0) {
            ...
            for (int ix = 0; ix < length; ix++) {
                ...
                if (tmpObject != null) {
                    status.pic_urls.add(tmpObject.optString("thumbnail_pic").replace("thumbnail","mw690"));
                }
            }
        }
