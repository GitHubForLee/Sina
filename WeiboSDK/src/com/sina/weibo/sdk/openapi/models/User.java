...
public class User implements Serializable{
    ...
    public static User parse(JSONObject jsonObject) {
        ...
        user.profile_image_url  = getIcon(jsonObject.optString("profile_image_url", ""));
    ...
    private static String getIcon(String s){
        ...
        builder.append(s.substring(0,third+1));
        builder.append("mw690");
        builder.append(s.substring(forth));
